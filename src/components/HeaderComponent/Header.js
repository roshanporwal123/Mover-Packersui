              ...
              <div className="container">
                <nav className="main-nav">
                  ...
                  <li className="has-sub">
                    <a> <NavLink to="/manageorders">Manage ▼</NavLink></a>
                    <ul className="sub-menu">
                    <li><NavLink to="/manageusers">ManageUsers</NavLink></li>
                    <li><NavLink to="/manageorders">ManageOrders</NavLink></li>
                    </ul>
                  </li>
                    
                    <li><NavLink to="/viewcharity">ViewCharity</NavLink></li>
                     <li className="has-sub">
                    <a> <NavLink to="/addcategory">Categories ▼</NavLink></a>
                    <ul className="sub-menu">
                    ...
                    <li className="has-sub">
                    <a> <NavLink to="/epadmin">Settings ▼</NavLink></a>
                    <ul className="sub-menu">
            ...
            <div className="container">
              <nav className="main-nav">
                ...
                <ul className="nav">
                  ...
                  <li><NavLink to="/viewcategory">Explore</NavLink></li>
                     
                        <li className="has-sub">
                    <a> <NavLink to="/epuser">Consignment ▼</NavLink></a>

                    <ul className="sub-menu">
                    <li><NavLink to="/addconsignment">Add Consignment</NavLink></li>
                      <li><NavLink to="/track"> Track Consignment</NavLink></li>
                    </ul>
                  </li>
                   <li className="has-sub">
                    <a> <NavLink to="/epuser">Settings ▼</NavLink></a>
            ...
            <div className="container">
              <nav className="main-nav">
                ...
                <ul className="nav">
                  ...
                  <li><NavLink to="/ai">AI Chat</NavLink> </li>
                  <li>
                    <NavLink to="/login">
